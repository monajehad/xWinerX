...
<div class="container">
    ...
    <form method="POST" class="col-10" action="{{ route('billing-addresses.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text col-6" class="form-control" id="city" name="city" required>
        </div>

        <!-- State -->
        <div class="form-group">
            <label for="state">Street</label>
            <input type="text col-6" class="form-control" id="street	" name="street	" required>
        </div>

        <!-- Postal Code (ZIP Code) -->
        <div class="form-group">
            <label for="postal_code">Postal Code (ZIP Code)</label>
            <input type="text col-6" class="form-control" id="postal_code" name="postal_code" required>
        </div>

        <!-- Country (Dropdown Select) -->
        <div class="form-group">
            <label for="country">Country</label>
            <select class="form-control col-6" id="country" name="country" required>
