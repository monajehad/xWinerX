<footer class="text-center bg-gray-100">
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <nav class="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold">
            ...
            <div class="flex-1 flex items-left justify-left content-left sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0 flex items-left">
                    ...
                    <p class="pt-5 max-w-lg mx-auto text-xs text-gray-500">
